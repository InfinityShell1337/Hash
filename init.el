...
(add-to-list 'default-frame-alist '(alpha . (75 . 90)))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(desktop-environment desktop-enviroment which-key visual-fill-column visual-fill use-package undo-tree rainbow-delimiters org-bullets lsp-mode ivy-rich hydra helpful general forge exwm evil-collection eshell-prompt-extras eshell-git-prompt doom-themes doom-modeline dired-single counsel-projectile auto-package-update all-the-icons-dired)))
(custom-set-faces
